  ...
  <div id="app">
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <div class="form-group text-center">
                <a class="btn btn-primary my-3 btn-lg btn-icon icon-right" href="{{ url('index') }}" tabindex="4">
                  Login As Guest
                </a>
              </div>
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="{{ asset('images/wallpaper.jpg') }}">
